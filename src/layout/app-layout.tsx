...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administradordo-sistema'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Animals', path: '/animals', entity: 'animal', service: AccessServiceEnum.PROJECT, icon: FiFeather },
    { name: 'Portals', path: '/portals', entity: 'portal', service: AccessServiceEnum.PROJECT, icon: FiGlobe },
